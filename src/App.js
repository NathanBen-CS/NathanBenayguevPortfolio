        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a href="/portRes.pdf" className="flex items-center space-x-2 text-[#C3C8D3] hover:text-[#4DE3C1] transition-colors group" download> 
                <div className='relative'>
                  <Briefcase className="w-5 h-5 group-hover:translate-y-1 transition-transform"></Briefcase>
                  <div className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-[#6C63FF] to-[#4DE3C1] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </div>
               <span>Resume</span>
              </a>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a 
                href="https://github.com/NathanBen-CSv" 
                target="_blank" 
